...
//    import scala.collection.JavaConversions.mapAsScalaMap
    ...
    val conf: MultiLayerConfiguration = new NeuralNetConfiguration.Builder()
      ...
      .updater(new Sgd(0.01)) // see options here https://github.com/deeplearning4j/deeplearning4j/blob/master/deeplearning4j-nn/src/main/java/org/deeplearning4j/nn/conf/Updater.java
//    .iterations(1)
//      .learningRate(0.01)
...
//        miniBatchNumber += 1
  ...
  /** Downloads Shakespeare training data and stores it locally (temp directory). Then set up and return a simple
    ...
    */
  @throws[Exception]
  def getIterator(miniBatchSize: Int, sequenceLength: Int): CharacterIterator = {
...
//    val fileLocation = tempDir + "/Shakespeare.txt" //Storage location from downloaded file
    val fileLocation = "/home/rawkintrevo/gits/scriptsdl4j/fetchdata/scripts/star-trek-tng/all-episodes.txt"
